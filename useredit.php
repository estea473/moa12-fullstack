...
$sql = "SELECT username, email, f_name, l_name, address, phone FROM users WHERE user_id = '$userid'";
...
<html lang="en">
  ...
  <body>
    <div class="edit-container">
      <!-- <h2>Edit Profile</h2> -->
      <form action="userprofil_edit_action.php" method="POST">
        <div class="edit">
          ...
          <input type="text" id="f_name" name="f_name" value="<?php echo htmlspecialchars($f_name); ?>" />

          <label for="l_name">Last Name</label>
          <input type="text" id="l_name" name="l_name" value="<?php echo htmlspecialchars($l_name); ?>" />
